...
const PrimaryTab: React.FC<TabsProps> = ({ tabs, onTabChange, btnText }) => {
  ...
  return (
    <div className="flex flex-col md:flex-row md:gap-8 bg-white/5 rounded-3xl border-2 border-white/10 p-4 md:p-6 md:py-12 h-auto md:h-[300px] lg:h-[360px] overflow-y-auto hide-scrollbar">
      {/* Left Tabs Container */}
      <div
      ...
      <div ref={contentSectionRef} className="flex-1 p-4 md:px-6">
        <h4 className="text-primary-orange text-2xl font-bold mb-4">
        ...
        {btnText.trim().length > 0 && (
          <Button className="bg-white text-primary-blue rounded-full px-8 md:px-16">
